...
public class App {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("8. Skill-3: HQL Operations (Sorting/Pagination/Aggregates)");
            ...
            switch (choice) {
                case 1 -> {
                    dao.addProduct(new Product("Laptop", "Electronics", 55000, 10));
                    dao.addProduct(new Product("Mouse", "Accessories", 500, 50));
                    dao.addProduct(new Product("Keyboard", "Accessories", 2500, 20));
